...
- Product manager view: [/web_resources/product_manager.html?user_id={user_id}](https://feedback-management-l0qx.onrender.com/web_resources/product_manager.html?user_id=1)
